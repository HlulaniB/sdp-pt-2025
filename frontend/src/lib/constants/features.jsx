...
//this is for the find partners page
...
export const recommendedPartners = [
    {
        ...
        year: "3rd",
        modules: [
            { code: "CGV", name: "Computer Graph..." },
            { code: "SDP", name: "Software Design..." },
        ],
    },
    {
        id: 2,
    ...
    },
    {
        ...
        year: "4th",
        modules: [
            { code: "NLP", name: "Natural Language Proc." },
            { code: "DM", name: "Data Mining" },
        ],
    },
];

export const myPartnersData = [
    { id: 1, name: "John Doe 1", course: "Mathematical Sc.", year: "3rd" },
    { id: 2, name: "John Doe 2", course: "Mathematical Sc.", year: "2nd" },
    { id: 3, name: "John Doe 3", course: "Mathematical Sc.", year: "3rd" },
    { id: 4, name: "John Doe 4", course: "Mathematical Sc.", year: "2nd" },
    { id: 5, name: "John Doe 5", course: "Mathematical Sc.", year: "3rd" },
    { id: 6, name: "John Doe 6", course: "Mathematical Sc.", year: "2nd" },
];
