            ...
            <main className="flex-1 p-3 sm:p-6 bg-slate-100 overflow-y-auto">
                <div className="space-y-6 sm:space-y-8">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-4 sm:space-y-0">
                        <h1 className="text-2xl sm:text-4xl font-bold bg-gradient-to-r from-blue-800 to-gray-500 bg-clip-text text-transparent">
                            Find Partners
                        </h1>
                        ...
                        <div className="overflow-x-auto">
                            ...
                            >
                                {recommendedPartners.map((partner) => (
                                    <div
                                        key={partner.id}
                                        className="bg-white rounded-2xl p-4 shadow-sm flex-shrink-0 w-64 sm:w-72"
                                    >
